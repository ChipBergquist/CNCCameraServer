...
CNCCameraHardware::CNCCameraHardware() {
          ...
          AStepperMotor = StepperMotorControl(X_DIR_PIN, X_STEP_PIN, X_ENABLE_PIN);
          ...
          ZStepperMotor = StepperMotorControl(Z_DIR_PIN, Z_STEP_PIN, Z_ENABLE_PIN);
}
